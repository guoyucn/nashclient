...
public class Card implements Comparable<Card> {
    ...
    public static String cardstoString(Card[] cards, String delimiter) {
    	return cardstoString(Arrays.asList(cards), delimiter);
    }
    
    public static String cardstoString(Iterable<Card> cards, String delimiter) {
        ...
        if(sb.length()>0 && delimiter != null)
        	return sb.toString().substring(0, sb.length()-delimiter.length()).trim();
